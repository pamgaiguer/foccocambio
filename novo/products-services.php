    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
      ...
      <div class="media">
        ...
        <div class="media-body">
          ...
          <p>
            Receba em seu endereço comercial ou residencial, sempre no dia útil seguinte a sua solicitação, com total <br>
            descrição e segurança feito por portadores de nossa empresa e sem custo nenhum.<br>
            Consulte-nos para valor mínimo e regiões atendidas.
          </p>
          <a href="delivery.php">Saiba Mais</a>
        </div>
      </div>
