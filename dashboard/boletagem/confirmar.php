...
<main>
  <div class="row">
    <div class="col s12">
      ...
      <H2>TODOS ABAIXO COM CAMPO READ ONLY</H2>
  ...
  <div class="row">
    <div class="col s12">
      ...
      <div class="input-field col s4">
        <input name="group1" type="checkbox" class="filled-in"  id="test1" />
        <label for="test1">Confirmar dados da boletagem acima</label>
      </div>
  ...
  <div class="row">
    <div class="col s12">
      ...
      <div class="input-field col s4">
        <label for="test1">Alguma informação acima está incorreta?</label>
      </div>
