    ...
    <table class="striped">
      ...
      <tbody>
        <tr>
          ...
          <td><input type="text" id="USD-txFinal" class="txFinal" value=""></td>
          <td><input type="text" id="USD-txSIofBoletagem" class="txSIofBoletagem" value=""></td>
          <td><input type="text" id="USD-margLiquidaPercent" class="margLiquidaPercent" value=""></td>
          <td><input type="text" id="USD-margLiquida" class="margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td>acima de 5.000 -1</td>
          <td><input type="text" id="EUR-txFinal" value=""></td>
          <td><input type="text" id="EUR-txSIofBoletagem" value=""></td>
          <td><input type="text" id="EUR-margLiquidaPercent" value=""></td>
          <td><input type="text" id="EUR-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td><input type="text" id="GBP-txFinal" value=""></td>
          <td><input type="text" id="GBP-txSIofBoletagem" value=""></td>
          <td><input type="text" id="GBP-margLiquidaPercent" value=""></td>
          <td><input type="text" id="GBP-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td>acima de 5.000 -1</td>
          <td><input type="text" id="AUD-txFinal" value=""></td>
          <td><input type="text" id="AUD-txSIofBoletagem" value=""></td>
          <td><input type="text" id="AUD-margLiquidaPercent" value=""></td>
          <td><input type="text" id="AUD-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td>acima de 5.000 -1</td>
          <td><input type="text" id="CAD-txFinal" value=""></td>
          <td><input type="text" id="CAD-txSIofBoletagem" value=""></td>
          <td><input type="text" id="CAD-margLiquidaPercent" value=""></td>
          <td><input type="text" id="CAD-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td>acima de 5.000 -1</td>
          <td><input type="text" id="CHF-txFinal" value=""></td>
          <td><input type="text" id="CHF-txSIofBoletagem" value=""></td>
          <td><input type="text" id="CHF-margLiquidaPercent" value=""></td>
          <td><input type="text" id="CHF-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td><input type="text" id="JPY-txFinal" value=""></td>
          <td><input type="text" id="JPY-txSIofBoletagem" value=""></td>
          <td><input type="text" id="JPY-margLiquidaPercent" value=""></td>
          <td><input type="text" id="JPY-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td><input type="text" id="NZD-txFinal" value=""></td>
          <td><input type="text" id="NZD-txSIofBoletagem" value=""></td>
          <td><input type="text" id="NZD-margLiquidaPercent" value=""></td>
          <td><input type="text" id="NZD-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td>a combinar gerência</td>
          <td><input type="text" id="CLP-txFinal" value=""></td>
          <td><input type="text" id="CLP-txSIofBoletagem" value=""></td>
          <td><input type="text" id="CLP-margLiquidaPercent" value=""></td>
          <td><input type="text" id="CLP-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td><input type="text" id="MXN-txFinal" value=""></td>
          <td><input type="text" id="MXN-txSIofBoletagem" value=""></td>
          <td><input type="text" id="MXN-margLiquidaPercent" value=""></td>
          <td><input type="text" id="MXN-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td><input type="text" id="UYU-txFinal" value=""></td>
          <td><input type="text" id="UYU-txSIofBoletagem" value=""></td>
          <td><input type="text" id="UYU-margLiquidaPercent" value=""></td>
          <td><input type="text" id="UYU-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td>a combinar gerência</td>
          <td><input type="text" id="ZAR-txFinal" value=""></td>
          <td><input type="text" id="ZAR-txSIofBoletagem" value=""></td>
          <td><input type="text" id="ZAR-margLiquidaPercent" value=""></td>
          <td><input type="text" id="ZAR-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td>acima de 5.000 -1</td>
          <td><input type="text" id="ARS-txFinal" value=""></td>
          <td><input type="text" id="ARS-txSIofBoletagem" value=""></td>
          <td><input type="text" id="ARS-margLiquidaPercent" value=""></td>
          <td><input type="text" id="ARS-margLiquida" value=""></td>
        </tr>
        <tr>
          ...
          <td>acima de 5.000 -1</td>
          <td><input type="text" id="CNY-txFinal" value=""></td>
          <td><input type="text" id="CNY-txSIofBoletagem" value=""></td>
          <td><input type="text" id="CNY-margLiquidaPercent" value=""></td>
          <td><input type="text" id="CNY-margLiquida" value=""></td>
        </tr>
      </tbody>
    </table>
  </div>
