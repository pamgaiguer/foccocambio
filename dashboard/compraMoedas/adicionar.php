...
<main>
  ...
  <form id="form-adicionar-compraMoedas">
    ...
    <div class="row">
      ...
      <div class="col s1">
        <label for="select-moedas">Valores/Moedas</label>
      ...
      <div class="input-field col s1">
        <input id="quantidade" name="quantidade" class="currency" type="text" placeholder=" " required>
        <label for="quantidade">Quantidade</label>
      </div>

      <div class="input-field col s1">
        <input id="taxa" name="taxa" type="text"  placeholder=" " required>
        <label for="taxa">Taxa</label>
      </div>

      <div class="input-field col s1">
        <input id="total" name="total" class="currency"  placeholder=" " type="text" readonly>
        <label for="total">Total</label>
      </div>

      <div class="input-field col s1">
        <input id="fechamento" name="fechamento"  placeholder=" " type="text">
    ...
    <div class="row">
      <div class="col s12">
        <a class="btn bg-blue right">Adicionar valor </a>
