<?php
    ...
    $message = "Email enviado pelo Fale Conosco do Site \n
		...
		Telefone: ".$tel." \n
		Mensagem: ".$msg."  \n";
		if(!mail($to, $subject, $message, $headers ,"-r".$to)){ 
			$headers .= "Return-Path: " . $to . $quebra_linha; 
		...
		<div class="main-page">
			...
			<div class="interna-all">
				...
				<div class="interna-meio">
					...
					<br>
					<fieldset>
						<form action="faleconoscoaction.php" method="post">
		...
		<footer>
			<div class="footer-all">
				<ul class="footer-quadro1">
					<li class="footer-uppercase">
						<a href="index.php" target="_self">Home</a>
					</li>
					<li>
						<a href="serv_atendCorporativo.php" target="_self">Atendimento Corporativo</a>
					</li>
					<li>
						<a href="serv_delivery.php" target="_self">Delivery</a>
					</li>
					<li>
						<a href="serv_duvidasfrequentes.php" target="_self">Dúvidas Frequentes</a>
					</li>
				</ul>
				<ul class="footer-quadro2">
					...
					<li>
						<a href="prod_cartoesprepagos.php" target="_self">Cartões Pré-Pagos</a>
					</li>
					<li>
						<a href="prod_moedaestrangeira.php" target="_self">Moedas Estrangeiras</a>
					</li>
					<li>
						<a href="prod_transfinternacionais.php" target="_self">Transferências Internacionais</a>
					</li>
				</ul>
				<ul class="footer-quadro3">
					...
					<li class="footer-uppercase tels-footer">
						Moema - (11) 5051-5299
					</li>
					<li class="footer-uppercase tels-footer">
						Pompéia - (11) 3862-3859
					</li>
					<li class="link-footer-align-right">
						<a href="mailto:contato@foccocambio.com.br">contato@foccocambio.com.br</a>
					</li>
				</ul>
