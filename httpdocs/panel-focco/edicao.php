...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE viagens SET idcategoria=%s, cidadedestino=%s, incluido=%s, fotochamada=%s, foto1=%s, foto2=%s, foto3=%s, foto4=%s, foto5=%s, foto6=%s, destaque=%s, valor=%s, promocao=%s WHERE idviagens=%s",
...
$colname_edicao = "-1";
if (isset($_GET['idviagens'])) {
  $colname_edicao = $_GET['idviagens'];
}
mysql_select_db($database_conn, $conn);
$query_edicao = sprintf("SELECT * FROM viagens WHERE idviagens = %s", GetSQLValueString($colname_edicao, "int"));
...
<div id="geral">
  ...
  <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
    <p class="logintitulo">
      <input name="id" type="hidden" id="id" value="<?php echo $row_edicao['idviagens']; ?>" />
      <br />
      Exibir no site
</p>
      ...
      <tr>
        ...
        <td width="147"><label>
          <select name="promocao" class="caixalogin" id="promocao">
            <option value="1" <?php if (!(strcmp(1, $row_edicao['promocao']))) {echo "selected=\"selected\"";} ?>>Sim</option>
<option value="2" <?php if (!(strcmp(2, $row_edicao['promocao']))) {echo "selected=\"selected\"";} ?>>N&atilde;o</option>
          </select>
        </label></td>
        <td width="80" class="txtgeral">Destaque:</td>
        <td width="146"><select name="destaque" class="caixalogin" id="destaque">
          <option value="1" <?php if (!(strcmp(1, $row_edicao['destaque']))) {echo "selected=\"selected\"";} ?>>Sim</option>
<option value="2" <?php if (!(strcmp(2, $row_edicao['destaque']))) {echo "selected=\"selected\"";} ?>>N&atilde;o</option>
        </select></td>
        <td width="80" class="txtgeral">Categoria:</td>
        <td width="146"><select name="idcategoria" class="caixalogin" id="idcategoria">
          <option value="1" <?php if (!(strcmp(1, $row_edicao['idcategoria']))) {echo "selected=\"selected\"";} ?>>Pacotes Nacionais</option>
          <option value="2" <?php if (!(strcmp(2, $row_edicao['idcategoria']))) {echo "selected=\"selected\"";} ?>>Pacotes Internacionais</option>
          <option value="3" <?php if (!(strcmp(3, $row_edicao['idcategoria']))) {echo "selected=\"selected\"";} ?>>Cruzeiros</option>
          <option value="4" <?php if (!(strcmp(4, $row_edicao['idcategoria']))) {echo "selected=\"selected\"";} ?>>Circuitos Brasileiros</option>
<option value="5" <?php if (!(strcmp(5, $row_edicao['idcategoria']))) {echo "selected=\"selected\"";} ?>>Resort</option>
        </select></td>
      </tr>
    </table>
    <p>&nbsp;</p>
    ...
    <table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="747"><label>
          <input name="cidadedestino" type="text" class="caixalogin" id="cidadedestino" value="<?php echo $row_edicao['cidadedestino']; ?>" size="70" />
          <span class="txtgeral">Ex. Santiago - Chile; Salvador</span></label></td>
      </tr>
      <tr>
        <td height="30" class="txtgeral">Valor do pacote:</td>
        <td><input name="valor" type="text" class="caixalogin" id="valor" value="<?php echo $row_edicao['valor']; ?>" size="50" /> 
      ...
      <tr>
        ...
        <td><label>
<textarea name="incluido" id="incluido" cols="91" rows="35"><?php echo $row_edicao['incluido']; ?></textarea>
        </label></td>
      </tr>
    </table>
    ...
    <table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="748"><label>
          <input name="fotochamada" type="text" class="caixalogin" id="fotochamada" value="<?php echo $row_edicao['fotochamada']; ?>" size="80" />
        </label></td>
      </tr>
      <tr>
        <td height="30" class="txtgeral">Foto 1:</td>
        <td><input name="foto1" type="text" class="caixalogin" id="foto1" value="<?php echo $row_edicao['foto1']; ?>" size="80" /></td>
      </tr>
      <tr>
        <td height="30" class="txtgeral">Foto 2:</td>
        <td><input name="foto2" type="text" class="caixalogin" id="foto2" value="<?php echo $row_edicao['foto2']; ?>" size="80" /></td>
      </tr>
      <tr>
        <td height="30" class="txtgeral">Foto 3:</td>
        <td><input name="foto3" type="text" class="caixalogin" id="foto3" value="<?php echo $row_edicao['foto3']; ?>" size="80" /></td>
      </tr>
      <tr>
        <td height="30" class="txtgeral">Foto 4:</td>
        <td><input name="foto4" type="text" class="caixalogin" id="foto4" value="<?php echo $row_edicao['foto4']; ?>" size="80" /></td>
      </tr>
      <tr>
        <td height="30" class="txtgeral">Foto 5:</td>
        <td><input name="foto5" type="text" class="caixalogin" id="foto5" value="<?php echo $row_edicao['foto5']; ?>" size="80" /></td>
      </tr>
      <tr>
        <td height="30" class="txtgeral">Foto 6:</td>
        <td><input name="foto6" type="text" class="caixalogin" id="foto6" value="<?php echo $row_edicao['foto6']; ?>" size="80" /></td>
      </tr>
    </table>
    <p>&nbsp;</p>
    <table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><label>
          <input name="submit" type="submit" class="caixalogin" id="submit" value="Atualizar pacote" />
        </label></td>
      </tr>
    </table>
