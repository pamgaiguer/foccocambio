		...
		<div class="main-page">
			...
			<div class="interna-all">
				<div class="interna-left">
					<img src="images/left-figure-transf-internacionais.png" alt="transferencias internacionais" class="img-transf">
				</div>
				<div class="interna-meio">
					<br><br>
					<img src="images/title-transferencias-internacionais.png" alt="title transferencias">
					<br><br>
					<hr>
					<br><br>
					<p class="interna-corazul">
						Através da Focco Câmbio e Turismo, o cliente conta com a possibilidade de efetuar ou receber transferências financeiras internacionais 
						devidamente autorizadas e regulamentadas pelo Banco Central do Brasil S.A, com total rapidez, transparência e segurança.
						<br><br>
						Dentre estes tipos de produtos, podemos destacar:
						<br><br>
						<strong>Manutenção de residente:</strong>
						Esta modalidade de operação procura atender aos brasileiros, familiares ou não, residentes em outros países a receber ajuda financeira de 
						brasileiros que moram no Brasil para se manter no exterior. O público principal destas operações são estudantes 
						universitários, adolescentes em intercâmbio e parentes próximos.
						<br><br>
						<strong>Cursos e congressos</strong>
						Esta modalidade de operação atende aos brasileiros buscando seu aperfeiçoamento em suas respectivas áreas de atuação ou que pretendem aprimorar seu idioma em 
						línguas estrangeiras através da participação em congressos, cursos de extensão ou mesmo ensino médio em escolas no exterior.
						<br><br>
						<strong>Transferência de patrimônio e transferências de Disponibilidade</strong>
						Esta modalidade de operação procura atender aos brasileiros que desejam realizar uma remessa de moeda estrangeira para o exterior com recursos advindos 
						da venda de algum patrimônio, por exemplo, residência, automóvel, outros.
						<br><br>
						Já a Transferência de Disponibilidade destina-se a investimentos no exterior e não podem ser sacados. Necessariamente devem ser resgatados através da 
						repatriação destes recursos, onde havendo lucro, incidirá imposto de renda.
						<br><br>
						<div class="interna-corazul destaque-contato">
						Para maiores esclarecimentos entre em contato com a equipe Focco.
						<br>
						Tire suas dúvidas: <br>
						<strong>(11) 5051-5299</strong><br>
						ou pelo e-mail: <strong><a href="mailto:contato@foccocambio.com.br" style="color: #002750">contato@foccocambio.com.br</a></strong>
						</div>
					</p>
				</div>				
			</div>
