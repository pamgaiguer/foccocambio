	...
	<body>
		...
		<div class="main-page">
			<header>
				...
				<div class="interna-all" style="min-height: 600px;">
					<div class="interna-left" style="min-height: 440px;">
					<img src="images/left-figure-atendcorp.png" alt="atendimento corporativo" class="left-figure-atendcorp">
					</div>
					<div class="interna-meio">
						<br>
						<img src="images/title-atendimento-corporativo.png">
						<br><br>
						<div id="interna-atendCorp">
							<p class="interna-corazul">
								Desenvolvemos uma estrutura diferenciada de atendimento a empresas, de forma a garantir sempre o melhor atendimento e 
								pontualidade nas entregas das operações programadas, com taxas altamente 
								competitivas e diversidade de moedas à disposição de nossos clientes.
							</p>
							<br>							
							<p class="interna-corazul">
								Através desta plataforma de atendimento, o cliente corporativo contará <br>com assistência operacional de 
								um executivo de contas exclusivo que o atenderá <br>em regime de horário comercial, sempre da melhor forma possível, 
								oferecendo <br>as melhores taxas e condições do mercado, contando com <br>todos nossos produtos (moeda estrangeira/cartões pré-pagos <br>e transferências internacionais) e serviços (delivery especializado).
							</p>
							<br>
							<!-- <p class="interna-corazul">
								Para sua comodidade, disponibilizamos o serviço de <a href="home_delivery.php" style="color: #00305F; font-weight: bold; ">Delivery</a>, onde <br>você, cliente Focco Câmbio e Turismo, poderá 
								efetuar sua consulta ou <br>reserva de moeda estrangeira pelo telefone <strong>(11) 5051 - 5299</strong>
							</p> -->
							<br>
							<img src="images/right-figure-atendcorp.png" alt="right-figure-corp" class="right-figure-atendcorp">
							<p class="interna-corazul">
								<strong>Consulte nossas taxas pois você irá se surpreender!</strong>
							</p>
						</div>
					</div>					
				</div>
