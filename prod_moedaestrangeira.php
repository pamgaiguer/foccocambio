		...
		<div class="main-page">
			...
			<div class="interna-all">
				<div class="interna-left">
					<img src="images/left-figure-delivery.png" alt="delivery" class="left-figure-delivery">
				</div>
				<div class="interna-meio">
					<br>
					<img src="images/title-moedas-estrangeiras.png" alt="moedas">
					<br><br>
					<p class="interna-corazul">
						É sempre recomendável converter reais diretamente na moeda do país em que você visitará, obtendo assim 
						uma negociação mais favorável, além de tornar a viagem mais confortável não havendo a necessidade 
						de ter que procurar casas de câmbio imediatamente na chegada.
						<br><br>
						<div class="interna-corazul espacamento-moedas">
							Algumas moedas que comercializamos:<br>
							<strong>.</strong> Dólar americano<br>
							<strong>.</strong> Euro<br>
							<strong>.</strong> Dólar canadense<br>
							<strong>.</strong> Dólar australiano<br>
							<strong>.</strong> Libras esterlinas<br>
							<strong>.</strong> Dólar neozelandês<br>
							<strong>.</strong> Franco suíço<br>
							<strong>.</strong> Iene<br>
							<strong>.</strong> Peso argentino<br>
							<strong>.</strong> Peso chileno<br>
							<strong>.</strong> Peso mexicano<br>
							<strong>.</strong> Rand<br>
						</div>
					</p>
					<br>
					<img src="images/moedas-estrangeiras-notas.png" alt="notas" class="img-notas">
					<br>
					<div class="banner-cartoes"></div>
					<br><br><br>
					<img src="images/title-delivery-focco.png">
					<br><br>
					<p class="interna-corazul">
						Entregamos a partir de USD 500,00 (ou equivalente em outra moeda), tanto <strong>ESPÉCIE</strong> quanto o <strong>CARTÃO</strong> pré-pago, sem custo nenhum, com total segurança e agilidade.<br>
						A equipe Focco está treinada para atendê-los!<br>
						Solicite sua entrega!<br>
					</p>
					<img src="images/delivery-telefone.png" alt="delivery-telefone" class="img-delivery">
					<br>
				</div>				
			</div>
		</div>	
